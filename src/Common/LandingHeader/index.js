  ...
  return (
    <div className="main">
      <nav
        ...
        style={{
          background:
            "linear-gradient(240deg, rgba(255,145,0,0.8) 0%, rgba(255,255,255,0.2) 57%, rgba(255,255,255,1) 73%, rgba(2,123,255,0.1) 100%)",
        }}
      >
        <div className="container">
          ...
          >
            <a className="navbar-brand" href="/">
              <img src={logo} alt="" className="header-login-logo" />
            </a>
            <span className="navbar-toggler-icon"></span>
          </button>
          <div
            className="collapse navbar-collapse fullscreen-menu"
            id="navbarTogglerDemo01"
          >
            <a className="navbar-brand logo-hidden" href="/">
              <img src={logo} alt="" className="header-login-logo" />
            </a>
