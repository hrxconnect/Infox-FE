      ...
      <div className="section-left">
        ...
        <div class="input-container">
          <div class="input-container label">
            <label for="first-name" id="header-labels">First Name</label>
          </div>
          <input
            type="text"
            id="firstname"
          ...
          <div class="input-container">
            <label for="last-name" id="header-labels">Last Name</label>
            <input
            type="text"
            id="lastname"
            name="lastname"
        ...
        <div class="input-container email-container" >
          <label for="email" id="header-labels">Email Address</label>
          <input
            type="email"
            id="email"
            name="email"
  ...
  {errors.confirmPassword && (
    <span id="confirmPasswordError" className="error-message">
      ...
      <p className="sign-in-text">
        Already have an account? <span className="highlight" onClick={()=> navigate("/login")}>Sign In</span>
      </p>
